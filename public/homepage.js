...
function setup() {
  ...
  background(0);
  planets.push(new Body(int(displayWidth/3-(displayWidth/3/2)),int(windowHeight-200),50));
  planets.push(new Body(int(displayWidth/3-(displayWidth/3/2)),int(windowHeight-200)+100,20));
